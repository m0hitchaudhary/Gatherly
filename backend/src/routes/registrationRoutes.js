...
// import { registrationLimiter } from '../middleware/rateLimiter.js'; //Was not imported earlier
...
//   cancelRegistration,
//   checkRefundStatus, // Make sure these are exported from your controller if you use them
//   checkRefundPolicy  // Make sure these are exported from your controller if you use them
...
import { authenticate } from '../middleware/auth.js';
import { authorizeRoles } from '../middleware/roles.js';
// Update the filename and import name here:
import { registrationRateLimiter as registrationLimiter } from '../middleware/rateLimiters.js';
import { 
  registerForEvent, 
  myRegistrations, 
  participantsForEvent, 
